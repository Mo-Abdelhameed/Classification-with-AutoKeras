...
def encode_target(targets: pd.Series, schema: ClassificationSchema) -> pd.Series:
    """
    Performs target encoding

    Args:
        targets (pd.Series): The original class labels.
        schema (ClassificationSchema): The schema of the data.

    returns:
        pd.Series: The encoded target classes.
    """
