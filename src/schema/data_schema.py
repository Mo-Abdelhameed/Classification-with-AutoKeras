...
class ClassificationSchema:
    ...
    def __init__(self, schema_dict: dict) -> None:
        """
        Initializes a new instance of the `ClassificationSchema` class
...
def load_json_data_schema(schema_dir_path: str) -> ClassificationSchema:
    """
    ...
    Returns:
        MulticlassClassificationSchema: An instance of the
    ...
    data_schema = ClassificationSchema(validated_schema_dict)
    return data_schema


def save_schema(schema: ClassificationSchema, save_dir_path: str) -> None:
    """
    Save the schema to a JSON file.

    Args:
        schema (MulticlassClassificationSchema): The schema to be saved.
...
def load_saved_schema(save_dir_path: str) -> ClassificationSchema:
    """
