...
- custom_num_units: (Array of Integers) Specifies the possible number of neurons (units) in each layer. For example, [30, 40, 50, 80, 90, 100] means the model will search among architectures with layers containing any of these numbers of neurons. The effect of this variable is present only when "custom_search" is true.
